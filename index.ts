  ...
  try {
    ...
    await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to: ["weihong_j@yahoo.com", "lixiaobing@gmail.com"],
        subject: "✅ 入站申请已批准",
        text: `已向 ${name} (${recipientEmail}) 发送邀请邮件。\n\n时间：${new Date().toLocaleString("zh-CN", { timeZone: "America/New_York" })}\n\n审批页面：https://dukeparents.org/approve.html`,
      }),
    });
